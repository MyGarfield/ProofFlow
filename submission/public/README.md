...
当前 main CI 为 `728 passed + 1 skipped = 729 collected`（[run 33304628887](https://github.com/MyGarfield/ProofFlow/actions/runs/33304628887)），本地 loopback Demo 定向测试为 `19 passed`。三臂评测资产已经
