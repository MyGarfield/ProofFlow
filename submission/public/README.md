...
当前 main CI 为 `771 passed + 1 skipped = 772 collected`（[run 33380863159](https://github.com/MyGarfield/ProofFlow/actions/runs/33380863159)），本地 loopback Demo 定向测试为 `19 passed`。三臂评测资产已经
