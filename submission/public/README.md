...
本公开说明最后一次点时 CI receipt 为 `main@bdb85f2` 的 `817 passed + 1 skipped = 818 collected`
（[run 33449398693](https://github.com/MyGarfield/ProofFlow/actions/runs/33449398693)），本地 loopback Demo 定向测试为 `19 passed`；该计数不是永久“当前”值。三臂评测资产已经
